...
>
  <div class="flex h-fit w-full items-center gap-2 border-l-8 border-(--colour) p-4">
    ...
    <enhanced:img src={albumArtURL} alt="Album Art" class="hidden h-20 w-20 rounded-xl xxs:block" />
  </div>
</div>
