...
<div in:fly={{ y: prefersReducedMotion.current ? 0 : 20, duration: 500 }} class="w-full">
  ...
  >
    ...
    <a
      ...
      href="/invite"
      class="z-10 flex items-center justify-center gap-1 rounded-full border-2 border-titanium-border bg-zinc-300 px-6 pt-2 pb-2 text-xl transition-colors hover:bg-zinc-400 dark:bg-zinc-800 dark:hover:bg-zinc-700"
    >
      <Plus size={30} />
