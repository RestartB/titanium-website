...
<header
	...
	class="fixed right-0 left-0 z-50 m-2.5 box-border flex items-center justify-center"
>
	<div
		class="border-titanium-border flex h-12 w-fit items-center gap-2.5 rounded-md border-1 bg-zinc-200 pr-2.5 pl-2.5 dark:bg-zinc-800"
	>
