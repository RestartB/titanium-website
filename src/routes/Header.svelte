...
<header
	...
	class="border-titanium-border box-border flex h-12 w-fit items-center justify-center gap-2.5 rounded-md border-1 bg-zinc-200/70 pr-2.5 pl-2.5 backdrop-blur-lg dark:bg-zinc-800/70"
>
