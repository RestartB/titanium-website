...
<div class="p-5 pt-19.5 flex flex-col gap-5 max-w-5xl">
	...
	<section class="flex flex-col gap-2.5" id="data">
		<h2 class="text-xl font-semibold">Stored Data</h2>
		<p>When you visit our website, we may collect basic information like IP addresses. This is required for the website to function.</p>
	</section>
	
	<section class="flex flex-col gap-2.5" id="errors">
		<h2 class="text-xl font-semibold">Cloudflare Analytics</h2>
		<p>We make use of Cloudflare Analytics, a privacy first and lightweight analytics solution, to get insights for our website. Some of the following data may be collected:</p>
		...
		<p>More data may be collected by Cloudflare. For more information, please go to the official <a href="https://www.cloudflare.com/en-gb/web-analytics/">Cloudflare Analytics page.</a></p>
	</section>
</div>